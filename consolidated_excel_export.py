...
from newspaper_corpus_analyzer import NewspaperCorpusAnalyzer, NEWSPAPER_NAMES
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python consolidated_excel_export.py <corpus_root_directory>")
        print("\nGenerates:")
        ...
        print("\nExample: python consolidated_excel_export.py /path/to/newspaper/corpus")
        sys.exit(1)
